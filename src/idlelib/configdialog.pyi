...
class FontPage(Frame):
    ...
    def on_fontlist_select(self, event: Event[Misc] | None) -> None: ...
    def set_samples(self, event: Event[Misc] | None = ...) -> None: ...
...
class KeysPage(Frame):
    ...
    def on_bindingslist_select(self, event: Event[Misc] | None) -> None: ...
...
class ExtPage(Frame):
    ...
    def extension_selected(self, event: Event[Misc] | None) -> None: ...
...
class HelpFrame(LabelFrame):
    ...
    def help_source_selected(self, event: Event[Misc] | None) -> None: ...
