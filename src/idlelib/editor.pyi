...
class EditorWindow:
    ...
    def handle_winconfig(self, event: Event[Misc] | None = ...) -> None: ...
    width: int
    def set_width(self) -> None: ...
    def new_callback(self, event: Event[Misc]) -> str: ...
    def home_callback(self, event: Event[Misc]) -> str: ...
    status_bar: MultiStatusBar
    def set_status_bar(self) -> None: ...
    def set_line_and_column(self, event: Event[Misc] | None = ...) -> None: ...
    ...
    def handle_yview(self, event: str, *args: float | object) -> str: ...
    rmenu: Menu | None
    event: Event[Misc]
    def right_menu_event(self, event: Event[Misc]) -> str: ...
    ...
    def about_dialog(self, event: Event[Misc] | None = ...) -> str: ...
    def config_dialog(self, event: Event[Misc] | None = ...) -> str: ...
    def help_dialog(self, event: Event[Misc] | None = ...) -> str: ...
    def python_docs(self, event: Event[Misc] | None = ...) -> str: ...
    def cut(self, event: Event[Misc]) -> str: ...
    def copy(self, event: Event[Misc]) -> str | None: ...
    def paste(self, event: Event[Misc]) -> str: ...
    def select_all(self, event: Event[Misc] | None = ...) -> str: ...
    def remove_selection(self, event: Event[Misc] | None = ...) -> str: ...
    def move_at_edge_if_selection(
        self,
        edge_index: int,
    ) -> Callable[[Event[Misc]], None]: ...
    def del_word_left(self, event: Event[Misc]) -> str: ...
    def del_word_right(self, event: Event[Misc]) -> str: ...
    def find_event(self, event: Event[Misc]) -> str: ...
    def find_again_event(self, event: Event[Misc]) -> str: ...
    def find_selection_event(self, event: Event[Misc]) -> str: ...
    def find_in_files_event(self, event: Event[Misc]) -> str: ...
    def replace_event(self, event: Event[Misc]) -> str: ...
    def goto_line_event(self, event: Event[Misc]) -> str: ...
    def open_module(self) -> str | None: ...
    def open_module_event(self, event: Event[Misc]) -> str: ...
    def open_module_browser(self, event: Event[Misc] | None = ...) -> str: ...
    def open_path_browser(self, event: Event[Misc] | None = ...) -> str: ...
    def open_turtle_demo(self, event: Event[Misc] | None = ...) -> str: ...
    def gotoline(self, lineno: int) -> None: ...
    def ispythonsource(self, filename: str) -> bool: ...
    def close_hook(self) -> None: ...
    def set_close_hook(self, close_hook: Callable[[], None]) -> None: ...
    ...
    def center_insert_event(self, event: Event[Misc]) -> str: ...
    ...
    def close_event(self, event: Event[Misc]) -> str: ...
    ...
    def smart_backspace_event(self, event: Event[Misc]) -> str: ...
    def smart_indent_event(self, event: Event[Misc]) -> str: ...
    def newline_and_indent_event(self, event: Event[Misc]) -> str: ...
