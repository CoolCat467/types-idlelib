...
class UndoDelegator(Delegator):
    ...
    def dump_event(self, event: Event[Misc] | None) -> str: ...
    was_saved: int
    pointer: int
    ...
    saved_change_hook: Callable[[], Any] | None
    ...
    def undo_event(self, event: Event[Misc] | None) -> str: ...
    def redo_event(self, event: Event[Misc] | None) -> str: ...
